...
const TaskGene = () => {
  ...
  const generateUserContent = () => {
    ...
    if (task === "Task" || task === "Melhoria") {
      userContent = `Cria uma tarefa de ${task}, para o ${type}:\n\ninformações da tarefa: \n${info} descrevendo as seguintes informações como subtitulo: Titulo da tarefa, Descrição do Problema, Critério de Aceitação, Notas Adicionais. O titulo da tarefa deve ser montada seguindo este critério (${team} - [${type}] + o titulo sobre a tarefa, faça titulos criativos).`;
    } else if (task === "Bug") {
      userContent = `Cria uma tarefa de ${task}, para o ${type}:\n\ninformações da tarefa: \n${info}  descrevendo as seguintes informações como subtitulo: Titulo da tarefa, Descrição do Problema, Cenário de Reprodução, Critério de Aceitação, Notas Adicionais. O titulo da tarefa deve ser montada seguindo este critério (${team} - [${type}] + o titulo sobre a tarefa, faça titulos criativos).`;
    } else if (task === "Test") {
      userContent = `Cria uma tarefa de ${task}, para o ${type}:\n\ninformações da tarefa: \n${info}  descrevendo as seguintes informações como subtitulo: Titulo da tarefa, Objetivo, Passos Realizados, Resultados Observados, Critério de Aceitação, Notas Adicionais. O titulo da tarefa deve ser montada seguindo este critério (Caso de Teste - ${team} - [${type}] - Testar).`;
    }
    return userContent;
  };
    ...
    <StyledTask className="limitador">
      <div className="limitador">
        ...
        <span>
          ...
          inteligência artificial que irá gerar respostas.
        </span>
        ...
        <form>
          ...
          <div className="form-group">
            <Button color="primary" type="button" onClick={generateTask}>
              Gerar Resposta
            </Button>
          </div>
